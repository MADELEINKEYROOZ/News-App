...
import com.example.newsapp.databinding.EnnewsdetailsBinding;
import com.example.newsapp.ui.album.CustomVolleyRequest;

public class EnglishDetailsActivity extends AppCompatActivity {
    EnnewsdetailsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = EnnewsdetailsBinding.inflate(getLayoutInflater());
